# kops_k8s
Install Kops and automate the creation of a production ready k8s cluster
## kops-kubernetes-cluster-configuration
## Deco Technologies, 
## Tel: +1 240 462 1760, 
## chederek07@gmaiL.com,
...
## Execute the commands below in your KOPS control Server. use unique s3 bucket name. If you get bucket name exists error.
 ...
 ## 6b) create an S3 bucket    
	...
	export NAME=derek.k8s.local
	export KOPS_STATE_STORE=s3://kopsderek1
